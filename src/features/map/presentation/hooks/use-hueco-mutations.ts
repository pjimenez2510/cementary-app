...
//       // Invalidar queries de cementerio (necesitamos obtener el id del cementerio)
//       // Esto se puede hacer invalidando todas las queries de cementerio o pasando el id del cementerio
//       queryClient.invalidateQueries({ queryKey: HUECO_QUERY_KEYS.byCementerio });
...
//       // Invalidar queries de cementerio
//       queryClient.invalidateQueries({ queryKey: HUECO_QUERY_KEYS.byCementerio });
