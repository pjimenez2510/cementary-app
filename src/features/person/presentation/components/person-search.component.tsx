...
export function PersonSearch({ onSearch, isSearching }: PersonSearchProps) {
    ...
    <Card className="w-full max-w-2xl mx-auto">
      <CardContent className="p-8">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Búsqueda de Personas</h2>
          <p className="text-gray-600">Busca por cédula, nombres o apellidos</p>
        </div>
