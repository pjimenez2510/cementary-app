                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <RHFCheckbox
                      ...
                      description="Copia certificada del acta de defunción"
                    ...
                    <RHFCheckbox
                      ...
                      control={methods.control}
                      label="Pago Tasa Inhumación"
                      description="Comprobante de pago de la tasa municipal"
                      className="p-4 bg-gray-50 rounded border"
                    />
                    ...
                    <RHFCheckbox
                      ...
                      control={methods.control}
                      label="Título Propiedad Nicho"
                      description="Copia del título de propiedad del nicho"
                      className="p-4 bg-gray-50 rounded border"
                    />
                    ...
                    <RHFCheckbox
                      ...
                      control={methods.control}
                      label="Autorización Movilización"
                      description="Autorización para movilización del cadáver"
                      className="p-4 bg-gray-50 rounded border"
                    />
                    ...
                    <div className="md:col-span-2">
                      <RHFCheckbox
                        ...
                        description="Documento oficial de solicitud de inhumación"
                        className="p-4 bg-gray-50 rounded border"
                      />
                    </div>
                  </div>
